...
WeakHashMap的存储结构类似于HashMap，读者可自行[参考前文](https://github.com/zxbyoyoyo/JCF-CodeAnalysis/blob/master/markdown/6-HashSet%20and%20HashMap.md)，这里不再赘述。
...
至此*Java Collections Framework Internals*系列已经全部讲解完毕，希望这几篇简短的博文能够帮助各位读者对Java容器框架建立基本的理解。通过这里可以返回[本系列文章目录](https://github.com/zxbyoyoyo/JCF-CodeAnalysis/blob/master/markdown/0-Introduction.md)
